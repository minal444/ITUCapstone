...
namespace FinancePortfolioAPI
{
    public class Crypto
    {
        //private static byte[] _salt = Encoding.ASCII.GetBytes("FinacePortFolioAPI");
        //private static string sharedSecret = "FinacePortFolioAPI";
        ///// <summary>
        ...
        {
            string EncryptionKey = "minalpatel";
